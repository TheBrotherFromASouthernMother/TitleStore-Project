...
class Customer(models.Model):
    ...
    cu_middle_name = models.CharField(max_length=200, blank=True, null = True)
    cu_suffix = models.CharField(max_length=200, blank=True, null = True)
    cu_email = models.EmailField(blank=True, null = True)
    cu_address_line_1 = models.CharField(max_length=200, blank=True, null = True)
    cu_address_line_2 = models.CharField(max_length=200, blank=True, null = True)
    cu_city = models.CharField(max_length=200, blank=True, null = True)
    cu_state = models.CharField(max_length=2, blank=True, null = True)
    cu_zip = models.CharField(max_length=10, blank=True, null = True)
    cu_country = models.CharField(max_length=200, blank=True, null = True)
    cu_county = models.CharField(max_length=200, blank=True, null = True)
    cu_phone_primary = models.CharField(max_length=200, blank=True, null = True)
    cu_photo_id_number = models.CharField("Driver's License/ID Number", blank=True, null = True, max_length=8)
    cu_photo_id_state = models.CharField(max_length=2, blank=True, null = True)
    cu_flag_military = models.NullBooleanField(blank=True, null = True)
